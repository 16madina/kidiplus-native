...
const styles = StyleSheet.create({
  ...
  cats: { flex: 1, flexDirection: "row", justifyContent: "space-evenly", gap: 4, paddingHorizontal: 2 },
  catBtn: { flex: 1, minHeight: 36, minWidth: 0, paddingHorizontal: 2, alignItems: "center" },
  catLabel: { color: "rgba(255,255,255,0.7)", fontWeight: "700", fontSize: 15, textAlign: "center" },
  catActive: { color: "#fff" },
