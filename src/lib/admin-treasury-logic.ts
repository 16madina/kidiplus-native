/** Platform Stripe vs seller IOU — used by the admin treasury card. */
...
export function currenciesOf(...maps: Array<MoneyByCur | null | undefined>): string[] {
...
/** Stripe available minus what we still owe / must keep (can be negative). */
...
/** Keep seller IOU + buyer wallets on the platform — only leftover is commission. */
